  ...
  try {
    ...
    return await requestContext.run<Promise<any>>(async () => {
      ...
      switch (route) {
        ...
        // ================= REFRESH TOKEN =================
        case '/auth/new-verification-code': {
        ...
        // ================= FIND EMAIL =================
        case '/auth/client-user/find-email': {
        ...
        // ================= REGISTER =================
        case '/auth/client-user/register': {
        ...
        // ================= VERIFY ACCOUNT =================
        case '/auth/client-user/verify-account': {
        ...
        // ================= PUBLIC ACCESS ALERT =================
        case '/auth/clinical-info-access-alert': {
