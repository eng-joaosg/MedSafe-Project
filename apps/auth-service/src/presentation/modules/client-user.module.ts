...
@Module({
  ...
  providers: [FindEmailClientUserHandler, RegisterClientUserHandler, VerifyAccountClientUserHandler],
  exports: [FindEmailClientUserHandler, RegisterClientUserHandler, VerifyAccountClientUserHandler],
})
